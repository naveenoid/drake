...
namespace geometric_contact_state_estimator {
namespace {
...
//const char *const kLcmOptitrackChannel = "IIWA_COMMAND";
...
//
//  auto plan_sub =
//      builder.AddSystem(systems::lcm::LcmSubscriberSystem::Make<robot_status_t>(
//          kLcmPlanChannel, &lcm));
...
int main(int argc, char* argv[]) {
  ...
  return drake::examples::kuka_iiwa_arm::geometric_contact_state_estimator::DoMain();
}
