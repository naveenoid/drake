...
//monolithic_pick_and_place::SynchronousWorldState;
 ...
 */
class ScriptedStateMachineSystem : public systems::LeafSystem<double> {
 public:
  /**
   ...
   */
  ScriptedStateMachineSystem(const Isometry3<double>& iiwa_base,
...
//  }
 ...
 private:
  ...
  const Eigen::MatrixXd kJointSequence;

  const std::unique_ptr<
      manipulation::planner::ConstraintRelaxingIk> planner_{nullptr};
  const std::unique_ptr<monolithic_pick_and_place::SynchronousWorldState> world_state_{nullptr};
};
