...
class StateMachineAndPrimitives : public systems::Diagram<T> {
 ...
 protected:
  monolithic_pick_and_place::IiwaMove* iiwa_move_{nullptr};
  ScriptedStateMachineSystem* whole_body_state_machine_{nullptr};
...
IiwaPlantGeneratorsEstimatorsAndVisualizer
 ...
 private:
  ...
  int input_port_iiwa_gains_{-1}; // reserved for intermediate to future use.
